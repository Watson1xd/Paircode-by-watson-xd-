...
const {  state, saveCreds } =await useMultiFileAuthState('./session/'+id)
   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      if (!!phoneNumber) {
         ...
         phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFor example: +263789622747 : `)))
         phoneNumber = phoneNumber.replace(/[^0-9]/g, '')

         // Ask again when entering the wrong number
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            console.log(chalk.bgBlack(chalk.redBright("Start with country code of your WhatsApp Number, Example : +263789622747")))
...
//------------------------------------------------------
    XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            await delay(1000 * 10)
            await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `🪀Support/Contact Developer\n\n\n⎆Donate: https://i.ibb.co/W2gYn6S/binance.png\n\n⎆YouTube: https://youtube.com/@WATSON_TECH\n\n⎆Telegram Channel: https://t.me/xeonbotinc\n\n⎆Telegram Chat: https://t.me/+AYOyJflnt-AzNGFl\n\n⎆WhatsApp Gc1: https://whatsapp.com/channel/0029VajjzuB9sBI890YffB1b\n\n⎆WhatsApp Gc2: https://whatsapp.com/channel/0029VajjzuB9sBI890YffB1b\n\n⎆WhatsApp Gc3: https://whatsapp.com/channel/0029VajjzuB9sBI890YffB1b\n\n⎆WhatsApp Pm: Wa.me/263789622747\n\n⎆Instagram: https://instagram.com/tinashex\n\n⎆GitHub: https://github.com/watsonxdboy/\n\n⎆Blog: https://dreamguyxeonfiles.blogspot.com/2022/05/bots%20whatsapp%20mods.html?m=1\n\n\n` });
            await delay(1000 * 2) 
...
│ Ohayo 😽
└┬❖  
┌┤✑  Thanks for using watson-xd-PairCode
│└────────────┈ ⳹        
│©2020-2024 WatsonBotInc 
└─────────────────┈ ⳹\n\n ` }, {quoted: xeonses});
              await delay(1000 * 2) 
              process.exit(0)
        }
